...
class Du163 {
  constructor(token, cookie){
    ...
    this.http = axios.create({
      ...
      timeout: 10*1000,
      headers: { 
        'User-Agent': 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 NEJSBridge/2.0 NeteaseSnailReader/1.9.65 NetType/WIFI (9527c63e8cae5d2fb1de942b64b48d9c;appstore)\'', 
        'Cookie': cookie,
